...
\bibitem{DESI_DR2}
DESI Collaboration, DESI-era BAO results and associated analysis papers (cite exact DR2 references used).

\bibitem{PantheonPlus}
S.~Brout \textit{et al.}, Pantheon+ supernova compilation (cite exact reference used).

\bibitem{Planck2018}
Planck Collaboration, ``Planck 2018 results. VI. Cosmological parameters'' (2018).

\bibitem{InteractingDEreview}
Review on interacting dark energy / dark-sector coupling (insert exact citation).

\bibitem{Quintom}
Canonical reference on quintom dark energy (insert exact citation).
