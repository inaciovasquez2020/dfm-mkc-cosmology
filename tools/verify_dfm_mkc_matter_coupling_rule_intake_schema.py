...
SCHEMA = ROOT / "schemas" / "dfm_mkc_matter_coupling_rule_intake_schema_v1.json"
ARTIFACT = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_matter_coupling_rule_intake_schema_2026_05_21.json"
BLOCKER = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_full_closure_blocker_certificate_2026_05_21.json"

TARGET_SLOT = "MatterCouplingRule"
...
NULL_FIELDS = {
    "coupled_matter_species",
    "stress_energy_definition",
    "density_evolution_rule",
    "pressure_or_equation_of_state",
    "conservation_law",
    "coupling_to_metric_or_background",
...
def main() -> None:
    ...
    print("DFM-MKC matter coupling rule intake schema verification OK.")
