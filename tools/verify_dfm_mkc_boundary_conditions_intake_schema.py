...
SCHEMA = ROOT / "schemas" / "dfm_mkc_boundary_conditions_intake_schema_v1.json"
ARTIFACT = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_boundary_conditions_intake_schema_2026_05_21.json"
BLOCKER = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_full_closure_blocker_certificate_2026_05_21.json"

TARGET_SLOT = "BoundaryConditions"
...
NULL_FIELDS = {
    ...
    "redshift_or_scale_factor_domain",
    "constraint_equations",
    "compatibility_with_source_terms",
    "compatibility_with_model_H_z",
...
def main() -> None:
    ...
    print("DFM-MKC boundary conditions intake schema verification OK.")
