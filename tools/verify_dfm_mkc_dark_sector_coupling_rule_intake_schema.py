...
SCHEMA = ROOT / "schemas" / "dfm_mkc_dark_sector_coupling_rule_intake_schema_v1.json"
ARTIFACT = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_dark_sector_coupling_rule_intake_schema_2026_05_21.json"
BLOCKER = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_full_closure_blocker_certificate_2026_05_21.json"

TARGET_SLOT = "DarkSectorCouplingRule"
...
NULL_FIELDS = {
    "dark_sector_variables",
    "dark_fluid_or_field_definition",
    "dark_energy_component_rule",
    "dark_matter_component_rule",
    "dark_sector_interaction_term",
    "coupling_to_deformation_field",
    "coupling_to_model_H_z",
...
def main() -> None:
    ...
    print("DFM-MKC dark-sector coupling rule intake schema verification OK.")
