...
SCHEMA = ROOT / "schemas" / "dfm_mkc_frozen_prediction_vector_intake_schema_v1.json"
ARTIFACT = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_frozen_prediction_vector_intake_schema_2026_05_21.json"
BLOCKER = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_full_closure_blocker_certificate_2026_05_21.json"

TARGET_SLOT = "FrozenPredictionVector"
...
NULL_FIELDS = {
    ...
    "observable_values",
    "observable_units",
    "redshift_or_scale_factor_points",
    "covariance_or_uncertainty_model",
    "model_version",
    "parameter_table_dependency",
    "dynamical_core_dependency",
    "generation_script",
    "generation_command",
    "freeze_timestamp",
    "hash_of_prediction_vector",
    "evidence_path",
    "evidence_sha256",
    "verifier_path",
    "test_path",
...
def main() -> None:
    ...
    print("DFM-MKC frozen prediction vector intake schema verification OK.")
