...
SCHEMA = ROOT / "schemas" / "dfm_mkc_source_terms_intake_schema_v1.json"
ARTIFACT = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_source_terms_intake_schema_2026_05_21.json"
BLOCKER = ROOT / "artifacts" / "repo_intake" / "dfm_mkc_full_closure_blocker_certificate_2026_05_21.json"

TARGET_SLOT = "SourceTerms"
...
NULL_FIELDS = {
    ...
    "source_term_equations",
    "right_hand_side_terms",
    "matter_source_dependencies",
    "dark_sector_source_dependencies",
    "deformation_field_source_dependencies",
    "conservation_or_balance_law",
...
def main() -> None:
    ...
    print("DFM-MKC source terms intake schema verification OK.")
