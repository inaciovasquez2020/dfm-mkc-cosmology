...
ARTIFACT = ROOT / "artifacts/repo_intake/dfm_mkc_independent_empirical_validation_intake_schema_2026_05_21.json"
SCHEMA = ROOT / "schemas/dfm_mkc_independent_empirical_validation_intake_schema_v1.json"
DOC = ROOT / "docs/status/DFM_MKC_INDEPENDENT_EMPIRICAL_VALIDATION_INTAKE_SCHEMA_2026_05_21.md"

REQUIRED_FUTURE_EVIDENCE = [
    "INDEPENDENT_DATASET_IDENTIFIER",
    "INDEPENDENT_PIPELINE_OR_REANALYSIS_REPORT",
    "FROZEN_PREDICTION_VECTOR_BINDING",
    "PREDECLARED_EVALUATION_PROTOCOL",
    "MODEL_COMPARISON_STATISTIC",
    "REPRODUCIBILITY_ARTIFACT_OR_EXTERNAL_REFERENCE",
]
...
DEPENDENCIES = [
    "artifacts/repo_intake/dfm_mkc_act_des_holdout_survival_intake_schema_2026_05_21.json",
...
def main() -> None:
    ...
    require(artifact["target_slot"] == "INDEPENDENT_EMPIRICAL_VALIDATION", "bad target slot")
    require(schema["target_slot"] == "INDEPENDENT_EMPIRICAL_VALIDATION", "bad schema target slot")
    require(artifact["schema"] == "schemas/dfm_mkc_independent_empirical_validation_intake_schema_v1.json", "bad schema pointer")
    ...
    print("DFM-MKC independent empirical validation intake schema verification OK.")
